...
%%----------------- Optimization Module
            ...
            \path   (vismodule.south)+(0.0,-1.15*\vdistlarge)  
                    ...
                    {\textbf{Optimize Hydropower Using Stochastic Programming for Different SF Forecast Scenarios } \\
                     (Akash Koppa et al. 2018)
                    };
...
% Model Calibration
            \path   (eosmodule.south)+(0.07,-1.1*\vdistlarge)  
                    ...
                    {\textbf{Setup of Noah-MP model for Study Domain Using NASA-LIS} \\
                    };
            ...
            \path   (eosmodule.south)+(0.07,-1.3*\vdistlarge)  
                    ...
                    {\textbf{Calibration of the Noah-MP model using Bayesian Algorithm DREAM} \\
                        (Koppa et al. 2019)
                    };
            ...
            \path   (eosmodule.south)+(0.07,-1.5*\vdistlarge)  
                    ...
                    {\textbf{Selection of Behavioral Parameters for Streamflow Forecasting}
                    };
% Hydrologic Forecasting 
            \path   (climmodule.south)+(0.07,-1.123*\vdistlarge)  
                    ...
                    {\textbf{Run Noah-MP model with Selected Parameters and Different Climate Forecast Scenarios} \\
                    };
